...
join (values
  ...
  ('แก๊สและสมบัติของแก๊ส', 'ความดันบรรยากาศ: บารอมิเตอร์และแมนอมิเตอร์', 6),
  ...
  ('สารละลาย', 'กฎของเฮนรีและความดันออสโมติก', 6),
  ...
  ('ของแข็งและของเหลว', 'ความตึงผิว ความหนืด และแรงเชื่อมแน่น-ยึดติด', 4),
  ('ของแข็งและของเหลว', 'ผลึกของแข็ง 4 ชนิดและแผนภาพวัฏภาค', 5)
